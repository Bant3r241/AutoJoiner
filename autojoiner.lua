...
-- URL where Node.js bot uploads the Job ID (make sure to update this URL)
local jobIdUrl = "https://example.com/jobid.txt"  -- Replace with your actual URL
...
while true do
    ...
    if success and content and content ~= "" then
        ...
        print("[Teleport Listener] No Job ID found.")  -- Debugging print
